alter table public.ba_dev_laptops drop constraint if exists ba_dev_laptops_goal_cents_check;
alter table public.ba_dev_laptops drop constraint if exists ba_dev_laptops_small_opening_bid_cents_check;
alter table public.ba_dev_laptops drop constraint if exists ba_dev_laptops_medium_opening_bid_cents_check;
alter table public.ba_dev_laptops drop constraint if exists ba_dev_laptops_large_opening_bid_cents_check;
alter table public.ba_dev_laptops drop constraint if exists ba_dev_laptops_min_increment_cents_check;

alter table public.ba_prod_laptops drop constraint if exists ba_prod_laptops_goal_cents_check;
alter table public.ba_prod_laptops drop constraint if exists ba_prod_laptops_small_opening_bid_cents_check;
alter table public.ba_prod_laptops drop constraint if exists ba_prod_laptops_medium_opening_bid_cents_check;
alter table public.ba_prod_laptops drop constraint if exists ba_prod_laptops_large_opening_bid_cents_check;
alter table public.ba_prod_laptops drop constraint if exists ba_prod_laptops_min_increment_cents_check;

alter table public.ba_dev_laptops add constraint ba_dev_laptops_goal_cents_check check (goal_cents between 10000 and 10000000000);
alter table public.ba_dev_laptops add constraint ba_dev_laptops_small_opening_bid_cents_check check (small_opening_bid_cents between 1000 and 1000000000);
alter table public.ba_dev_laptops add constraint ba_dev_laptops_medium_opening_bid_cents_check check (medium_opening_bid_cents between 1000 and 1000000000);
alter table public.ba_dev_laptops add constraint ba_dev_laptops_large_opening_bid_cents_check check (large_opening_bid_cents between 1000 and 1000000000);
alter table public.ba_dev_laptops add constraint ba_dev_laptops_min_increment_cents_check check (min_increment_cents between 100 and 100000000);

alter table public.ba_prod_laptops add constraint ba_prod_laptops_goal_cents_check check (goal_cents between 10000 and 10000000000);
alter table public.ba_prod_laptops add constraint ba_prod_laptops_small_opening_bid_cents_check check (small_opening_bid_cents between 1000 and 1000000000);
alter table public.ba_prod_laptops add constraint ba_prod_laptops_medium_opening_bid_cents_check check (medium_opening_bid_cents between 1000 and 1000000000);
alter table public.ba_prod_laptops add constraint ba_prod_laptops_large_opening_bid_cents_check check (large_opening_bid_cents between 1000 and 1000000000);
alter table public.ba_prod_laptops add constraint ba_prod_laptops_min_increment_cents_check check (min_increment_cents between 100 and 100000000);
...
begin
  ...
  if p_goal_cents not between 10000 and 10000000000
    or p_small_opening_bid_cents not between 1000 and 1000000000
    or p_medium_opening_bid_cents not between 1000 and 1000000000
    or p_large_opening_bid_cents not between 1000 and 1000000000
    or p_min_increment_cents not between 100 and 100000000 then
...
begin
  ...
  if p_spot_position not between 1 and 10
    or p_amount_cents not between 1000 and 10000000000
